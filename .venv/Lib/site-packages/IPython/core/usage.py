...
* Persistent command history across visits.
...
%hist -g foo     : Search command history of (almost) all visits for 'foo'.
%hist -g         : Command history of (almost) all visits.
%hist 1/2-8      : Command history containing lines 2-8 of session 1.
%hist 1/ ~2/     : Command history of session 1 and 2 visits before current.
%hist ~8/1-~6/5  : Command history from line 1 of 8 visits ago to
                   line 5 of 6 visits ago.
