...
class HistoryAccessor(HistoryAccessorBase):
    ...
    def init_db(self):
        ...
        self.db.execute("""CREATE TABLE IF NOT EXISTS visits (session integer
    ...
    def get_session_info(self, session):
        ...
        """
        query = "SELECT * from visits where session == ?"
    ...
    def get_range(self, session, start=1, stop=None, raw=True,output=False):
        ...
        output : bool
            ...
            visits if db_log_output was enabled at the time. Where no output
...
class HistoryManager(HistoryAccessor):
    ...
    def new_session(self, conn=None):
        ...
        with conn:
            cur = conn.execute("""INSERT INTO visits VALUES (NULL, ?, NULL,
    ...
    def end_session(self):
        ...
        self.writeout_cache()
        with self.db:
            self.db.execute("""UPDATE visits SET end=?, num_cmds=? WHERE
    ...
    def name_session(self, name):
        ...
        with self.db:
            self.db.execute("UPDATE visits SET remark=? WHERE session==?",
