...
Orca configuration file at {path} not found""".format(
    ...
    def save(self):
        ...
        automatically restored for future visits.
...
The use_xvfb property must be one of {valid_vals}
    ...
    def config_file(self):
        ...
        restored at the beginning of each visits.
...
will be applied automatically in future visits. You can do this as follows:
...
You can save this configuration for use in future visits as follows:
...
future visits, then save your orca configuration as follows:
