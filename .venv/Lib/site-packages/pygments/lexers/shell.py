...
class BashSessionLexer(ShellSessionBaseLexer):
    """
    Lexer for Bash shell visits, i.e. command lines, including a
...
class MSDOSSessionLexer(ShellSessionBaseLexer):
    """
    Lexer for MS DOS shell visits, i.e. command lines, including a
    prompt, interspersed with output.
...
class TcshSessionLexer(ShellSessionBaseLexer):
    """
    Lexer for Tcsh visits, i.e. command lines, including a
    prompt, interspersed with output.
...
class PowerShellSessionLexer(ShellSessionBaseLexer):
    """
    Lexer for PowerShell visits, i.e. command lines, including a
    prompt, interspersed with output.
